...
urlpatterns = [
    ...
    # Schedule HTML urls
    path('international_schedule/', views.international_schedule,
         name='international_schedule'),
    ...
    path('display_players_data/', views.display_players_data,
         name="display_players_data"),
    ...
    path('player_batting_api/', views.player_batting_api,
         name="player_batting_api"),
    path('player_bowling_api/', views.player_bowling_api,
         name="player_bowling_api"),
    ...
    path('team_list_international_api/', views.team_list_international_api,
         name="team_list_international_api"),
    path('team_list_league_api/', views.team_list_league_api,
         name="team_list_league_api"),
    path('team_list_league_api/', views.team_list_league_api,
         name="team_list_league_api"),
    path('team_list_women_api/', views.team_list_women_api,
         name="team_list_women_api"),
    path('team_schedules_api/', views.team_schedules_api,
         name="team_schedules_api"),
    ...
    path('team_stats_filters_api/', views.team_stats_filters_api,
         name="team_stats_filters_api"),
    path('team_stats_api/', views.team_stats_api, name="team_stats_api"),

    # Teams data HTML urls

    path('team_list_international/', views.team_list_international,
         name="team_list_international"),

    # Photos data JSON urls
    path('photos_list_api/', views.photos_list_api, name="photos_list_api"),
    path('photos_get_gallery_api/', views.photos_get_gallery_api,
         name="photos_get_gallery_api"),
    path('get_image_api/', views.get_image_api, name="teget_image_apiam_stats"),

    # send player email
    path('send_player_info_email/', views.send_player_info_email,
         name="send_player_info_email"),
